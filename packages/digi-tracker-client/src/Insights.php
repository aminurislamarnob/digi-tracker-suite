...
namespace PluginizeLab\DigiTracker;

/**
 * Digi Tracker Insights
 *
...
class Insights
{
    ...
    public function __construct($client, $name = null, $file = null)
    {
        ...
        if (is_object($client) && is_a($client, 'PluginizeLab\DigiTracker\Client')) {
            $this->client = $client;
        }
    }
    ...
    /**
     * Send tracking data to Digi Tracker server
     *
    ...
    public function admin_notice()
    {
        ...
        $policy_url = apply_filters('digi_tracker_privacy_policy_url', 'https://pluginizelab.com/privacy-policy/');
        ...
        $notice .= 'Your data is sent to <em>Digi Tracker</em>, operated by PluginizeLab. <a href="'.$policy_url.'" target="_blank">Learn more</a> &#8599;</p>';
    ...
    public function add_weekly_schedule($schedules)
    {
        $schedules['weekly'] = [
            ...
            'display' => __('Once Weekly', 'digi-tracker'),
        ];
    ...
    public function uninstall_reason_submission()
    {
        ...
        if (! wp_verify_nonce(sanitize_key(wp_unslash($_POST['nonce'])), 'digi-tracker-security-nonce')) {
    ...
    public function deactivate_scripts()
    {
        ...
        $custom_reasons = apply_filters('digi_tracker_custom_deactivation_reasons', [], $this->client);
        ?>
            ...
            <div class="wd-dr-modal-wrap">
                ...
                <div class="wd-dr-modal-body">
                    ...
                    <p class="wd-dr-modal-reasons-bottom">
                        <?php
                        echo sprintf(
                            $this->client->__trans('Your feedback is sent to <a href="%1$s" target="_blank">Digi Tracker</a>, operated by PluginizeLab, to troubleshoot problems &amp; make product improvements. <a href="%2$s" target="_blank">Learn more</a> &#8599;'),
                            esc_url(apply_filters('digi_tracker_homepage_url', 'https://pluginizelab.com/')),
                            esc_url(apply_filters('digi_tracker_privacy_policy_url', 'https://pluginizelab.com/privacy-policy/'))
                        );
        ?>
                    </p>
                </div>
                ...
                $(function() {
                    ...
                    modal.on('click', 'button.wd-dr-submit-modal', function(e) {
                        ...
                        $.ajax({
                            ...
                            type: 'POST',
                            data: {
                                nonce: '<?php echo wp_create_nonce('digi-tracker-security-nonce'); ?>',
    ...
    private function get_user_ip_address()
    {
         ...
         * Deliberately empty.
         *
         * Upstream asks icanhazip.com for the site's own public address on
         * every heartbeat: an undisclosed outbound request from the
         * customer's server to a third party named in no privacy policy.
         *
         * It also answers a question we can answer for free -- our endpoint
         * already sees the address the request arrived from, and derives the
         * country there. The field stays in the payload for wire
    ...
    /**
     * Report that the user declined the opt-in dialog
     */
