...
class Client
{
     ...
     * The client version.
     *
     * Sent as `client` on every request and recorded server-side. Prefixed
     * so that an endpoint accepting both this fork and the unmodified
     * upstream can tell at a glance which one produced a payload -- the two
     * have different version histories and the bare numbers would collide.
     *
     * @var string
     */
    public $version = 'dt-1.0.0';
